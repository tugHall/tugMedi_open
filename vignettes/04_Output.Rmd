...
-   genesMalfunc: Genes malfunctioned.

-   genesWmutsNoExp: Genes with mutations not expressed. Such mutations are passenger mutations, or driver mutations on either parental chromosome in the recessive genetic mode.
...
-   MalfunctionedByPointMut: Logical indicator of whether or not the gene is malfunctioned by the pom.
...
Input data that once went through the program, which are used for confirmation.\
