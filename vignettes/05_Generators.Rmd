...
-   The same parameter values are used for the output file, unless it is instructed to change ones in CF.parameters.txt.
...
-   dist\$*hallmark_name*\$spec: spec of rtrunc() in the library of truncdist
...
-   The same parameter values are used for the output file, unless it is instructed to change ones in hallmark_weights.parameters.txt.
...
-   dist\$*hallmark_name*\$spec: Either of 'dirichlet', 'dirichlet.mode', or 'dirichlet.mean'.
    ...
    -   'dirichlet': rdirichlet() in the dirmult library is used to generate random numbers based on the alpha parameters.
...
-   The same parameter values are used for the output file, unless it is instructed to change ones in parameters.parameters.txt.
...
-   dist\$*parameter_name*\$spec: spec of rtrunc() in the library of truncdist
...
-   The same parameter values are used for the output file, unless it is instructed to change ones in EF.Rint.parameters.txt.
...
-   dist\$*column_name*\$spec: spec of rtrunc() in the library of truncdist

    -   norm (or pois) is recommended for the Time_step column.

    -   Without prior knowledge, unif may be used at first.
...
-   dist\$EEL\$spec: spec of rtrunc() in the library of truncdist
...
-   The same parameter values are used for the output file, unless it is instructed to change ones in Rint.parameters.txt.
